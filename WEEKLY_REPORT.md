...
Generated: `2026-07-22T20:48:58Z` (via `scripts/write_weekly_report.py`)

### System

| Item | Status |
|------|--------|
| Branch | `git log -1` → `6c369c8 Flag severe Polymarket outages after five hours (T1-75).` |
...
status=OK lines=5007 json_lines=5007 bad_lines=0
runtime_basis=requote
runtime_hours=8.3700
runtime_hours_all_events=13.8168
quote_events=5529
requote_lines=2843
...
```
status=BLOCKED blockers=hours_ok,health_ok,outage_closed,oos_replicated,holdout_not_thin runtime_h=8.3700 quotes=5529 health=STALE last_requote_age_s=19624.161 outage_open=True outage_total_h=5.352 outage_alert=True outage_alert_severe=True oos=False thin=True vol_gap=0.04 quiet_vol_max=1.989 trend_vol_min=2.029 suggested_vol=2.489 suppress_2=0.0 suppress_suggested=0.1875 suppress_target=1.0 false_trending_attr_frac=1.0 boundary_tight=True
```

`uv run python scripts/summarize_strategy_cycles.py`:

```
status=OK cycles=73 runtime_h=8.37 hours_remaining=15.63 eta_wall_h=None eta_paused=True outage_open=True outage_total_h=5.3521 outage_alert=True outage_alert_severe=True quotes_per_wall_h=354.4 health=STALE last_requote_age_s=19620.553 tape_frozen=True connectivity=SKIPPED crossed_frac=0.0000 markout_30s=0.000006 false_trending_frac=1.0 false_trending_cancel_share=0.718563 vol_only_frac=1.0 vol_gap=0.04 quiet_vol_max=1.989 trend_vol_min=2.029 suggested_vol=2.489 false_trending_attr_frac=1.0 c01=BLOCKED c01_blockers=hours_ok,health_ok,outage_closed,oos_replicated,holdout_not_thin suppress_2=0.0 suppress_suggested=0.1875 suppress_target=1.0 unused_set=9 paper_schema=OK
```
