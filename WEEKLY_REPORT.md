...
Generated: `2026-07-22T22:58:55Z` (via `scripts/write_weekly_report.py`)

### System

| Item | Status |
|------|--------|
| Branch | `git log -1` → `88e2b05 Include Tier-1 done counts in WEEKLY_REPORT (T1-88).` |
...
| Tier-1 changelog lines | `134` (from `CHANGELOG_AGENT.md`) |
| Tier-1 backlog done | `89` (from `BACKLOG.md` Status: done) |
...
```
ts=2026-07-22T22:58:20.261270+00:00
connectivity=status=DOWN rest_ok=False ws_ok=False
outage_open=True
outage_total_h=7.5075
outage_alert=True
...
tape_frozen=True
eta_paused=True
last_requote_age_s=27383.703
last_quote_age_s=27383.705
health=STALE
```
...
status=OK lines=5399 json_lines=5399 bad_lines=0
runtime_basis=requote
runtime_hours=8.3700
runtime_hours_all_events=15.9838
quote_events=5529
requote_lines=2843
