...
def main() -> int:
    ...
    print(
        ...
        f"outage_alert_final={ost.get('outage_alert_final')} "
        f"outage_alert_critical_aged={ost.get('outage_alert_critical_aged')} "
        f"outage_alert_critical_hour={ost.get('outage_alert_critical_hour')} "
