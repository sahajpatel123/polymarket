...
def main() -> int:
    ...
    rep = {
        ...
        "last_outage_alert_critical_aged": (last.get("outage_status") or {}).get(
            "outage_alert_critical_aged"
        ),
        "last_outage_alert_critical_hour": (last.get("outage_status") or {}).get(
        ...
        "last_outage_critical_since": (last.get("outage_status") or {}).get(
            "outage_critical_since"
        ),
        "last_hours_past_critical": (last.get("outage_status") or {}).get(
            "hours_past_critical"
        ),
        "last_minutes_past_critical": (last.get("outage_status") or {}).get(
    ...
    if live_ost_path.exists():
        ...
        for src, dst in (
            ...
            ("outage_critical_since", "last_outage_critical_since"),
            ("hours_past_critical", "last_hours_past_critical"),
            ("minutes_past_critical", "last_minutes_past_critical"),
            ...
            ("outage_alert_critical_aged", "last_outage_alert_critical_aged"),
            ("outage_alert_critical_hour", "last_outage_alert_critical_hour"),
    ...
    print(
        ...
        f"outage_alert_critical_aged={rep.get('last_outage_alert_critical_aged')} "
        f"outage_alert_critical_hour={rep.get('last_outage_alert_critical_hour')} "
        ...
        f"outage_critical_since={rep.get('last_outage_critical_since')} "
        f"hours_past_critical={rep.get('last_hours_past_critical')} "
        f"minutes_past_critical={rep.get('last_minutes_past_critical')} "
