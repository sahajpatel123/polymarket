...
### T1-160 delta_min_ticks EV sweep
- Status: `done`
- Done when: `delta_min_ev_sweep` on Newsom/Vance; finding=false (fully
  inert dn_ev=0); keep live_scaled delta_min_ticks=1; evidence JSON.
